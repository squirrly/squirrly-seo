    ...
    $.extend({
        progressBar: new function() {
            ...
            this.defaults = {
                ...
                stepDuration: 2,
                max: 10, // Upon 100% i'd assume, but configurable
                ...
                boxImage: sq_baseurl + sq_uri + '/js/images/progressbar.gif', // boxImage : image around the progress bar
                barImage: {
                    0: sq_baseurl + sq_uri + '/js/images/progressbg_red.gif',
                    3: sq_baseurl + sq_uri + '/js/images/progressbg_orange.gif',
                    7: sq_baseurl + sq_uri + '/js/images/progressbg_green.gif'
                },
                // Internal use
                running_value: 0,
                value: 0,
